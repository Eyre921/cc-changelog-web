...
- **丰富微交互** — 滚动进度条、卡片入场交错、hover 光波、统计数字滚动计数、时间线脉冲、hero 浮动粒子、卡片 3D 微倾斜、高亮卡片呼吸灯、hero 标题渐变流动、徽章微光扫过
...
- **动效升级** —— 新增 hero 标题渐变流动、高亮卡片边框呼吸灯、卡片 3D 微倾斜、徽章微光扫过、终端悬浮发光、stats 悬停上浮、时间线悬停展开等微交互
